...
//          .build(new ResourceLocation(JojoMod.MOD_ID, "___").toString()));
    ...
    public static final RegistryObject<EntityType<KQBombEntity>> KQ_BOMB = ENTITIES.register("kq_bomb", 
            () -> EntityType.Builder.<KQBombEntity>of(KQBombEntity::new, EntityClassification.MISC).sized(1, 1).noSummon().noSave().setUpdateInterval(20)
            .build(new ResourceLocation(JojoMod.MOD_ID, "kq_bomb").toString()));
    
    public static final RegistryObject<EntityType<HGGrapplingStringEntity>> STONE_FREE_GRAPPLING_STRING = ENTITIES.register("stone_free_grappling_string", 
            () -> EntityType.Builder.<HGGrapplingStringEntity>of(HGGrapplingStringEntity::new, EntityClassification.MISC).sized(0.25F, 0.25F).noSummon().noSave().setUpdateInterval(20)
            .build(new ResourceLocation(JojoMod.MOD_ID, "stone_free_grappling_string").toString()));
    
    public static final RegistryObject<EntityType<LangSpitEntity>> LANG_SPIT = ENTITIES.register("lang_spit", 
            () -> EntityType.Builder.<LangSpitEntity>of(LangSpitEntity::new, EntityClassification.MISC).sized(0.25F, 0.25F).clientTrackingRange(4).updateInterval(10)
            .build(new ResourceLocation(JojoMod.MOD_ID, "lang_spit").toString()));
    
    public static final RegistryObject<EntityType<TuskAct4BulletEntity>> TUSK_BULLET = ENTITIES.register("tusk_bullet", 
            () -> EntityType.Builder.<TuskAct4BulletEntity>of(TuskAct4BulletEntity::new, EntityClassification.MISC).sized(0.25F, 0.25F).clientTrackingRange(4).updateInterval(10)
            .build(new ResourceLocation(JojoMod.MOD_ID, "tusk_bullet").toString()));
    
    public static final RegistryObject<EntityType<CloneEntity>> ENTITY_CLONE = ENTITIES.register("entity_clone", 
            () -> EntityType.Builder.<CloneEntity>of(CloneEntity::new, EntityClassification.MISC).sized(0.65F, 1.95F).noSummon().setShouldReceiveVelocityUpdates(false).setUpdateInterval(2).noSave()
            .build(new ResourceLocation(JojoMod.MOD_ID, "entity_clone").toString()));
    ...
    public static final RegistryObject<EntityType<SoftAndWetBubbleEntity>> SOFT_AND_WET_BUBBLE = ENTITIES.register("soft_and_wet_bubble", 
            ...
            .build(new ResourceLocation(JojoMod.MOD_ID, "soft_and_wet_bubble").toString()));
