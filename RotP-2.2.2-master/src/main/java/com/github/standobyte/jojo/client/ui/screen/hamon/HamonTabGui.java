...
public abstract class HamonTabGui extends AbstractGui {
    ...
    void drawContents(MatrixStack matrixStack, int mouseX, int mouseY, float partialTick, float xOffset, float yOffset) {
        if (!leftUpperCorner) {
            scrollX = 0;
            scrollY = 0;
        ...
        drawActualContents(matrixStack, mouseX - (int) xOffset, mouseY - (int) yOffset);
    ...
    protected abstract void drawActualContents(MatrixStack matrixStack, int mouseX, int mouseY);
    ...
    final void renderButtons(MatrixStack matrixStack, int mouseX, int mouseY, float partialTick) {
