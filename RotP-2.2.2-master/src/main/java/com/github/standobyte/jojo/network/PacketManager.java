...
import com.github.standobyte.jojo.network.packets.fromserver.AFPacket;
...
public class PacketManager {
    ...
    public static void init() {
        ...
        channel.registerMessage(index++, ClLayoutHotbarPacket.class,
                ClLayoutHotbarPacket::encode,
                ClLayoutHotbarPacket::decode,
                ClLayoutHotbarPacket::handle, Optional.of(NetworkDirection.PLAY_TO_SERVER));
        
        channel.registerMessage(index++, ClLayoutQuickAccessPacket.class,
                ClLayoutQuickAccessPacket::encode,
                ClLayoutQuickAccessPacket::decode,
                ClLayoutQuickAccessPacket::handle, Optional.of(NetworkDirection.PLAY_TO_SERVER));
        ...
        channel.registerMessage(index++, ClHamonPickTechniquePacket.class,
                ClHamonPickTechniquePacket::encode,
                ClHamonPickTechniquePacket::decode,
                ClHamonPickTechniquePacket::handle, Optional.of(NetworkDirection.PLAY_TO_SERVER));
        
        channel.registerMessage(index++, ClHamonAbandonButtonPacket.class,
                ClHamonAbandonButtonPacket::encode,
                ClHamonAbandonButtonPacket::decode,
                ClHamonAbandonButtonPacket::handle, Optional.of(NetworkDirection.PLAY_TO_SERVER));
        ...
        channel.registerMessage(index++, ClWalkmanControlsPacket.class,
                ClWalkmanControlsPacket::encode,
                ClWalkmanControlsPacket::decode,
                ClWalkmanControlsPacket::handle, Optional.of(NetworkDirection.PLAY_TO_SERVER));
        ...
        channel.registerMessage(index++, AFPacket.class, 
                AFPacket::encode, 
                AFPacket::decode, 
                AFPacket::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        ...
        channel.registerMessage(index++, ActionsFullLayoutPacket.class,
                ActionsFullLayoutPacket::encode,
                ActionsFullLayoutPacket::decode,
                ActionsFullLayoutPacket::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        ...
        channel.registerMessage(index++, HamonSkillAddPacket.class,
                HamonSkillAddPacket::encode,
                HamonSkillAddPacket::decode,
                HamonSkillAddPacket::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        
        channel.registerMessage(index++, TrHamonCharacterTechniquePacket.class,
                TrHamonCharacterTechniquePacket::encode,
                TrHamonCharacterTechniquePacket::decode,
                TrHamonCharacterTechniquePacket::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        
        channel.registerMessage(index++, HamonSkillRemovePacket.class,
                HamonSkillRemovePacket::encode,
                HamonSkillRemovePacket::decode,
                HamonSkillRemovePacket::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        ...
        channel.registerMessage(index++, TrHamonBreathStabilityPacket.class,
                TrHamonBreathStabilityPacket::encode,
                TrHamonBreathStabilityPacket::decode,
                TrHamonBreathStabilityPacket::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        
        channel.registerMessage(index++, TrHamonEnergyTicksPacket.class,
                TrHamonEnergyTicksPacket::encode,
                TrHamonEnergyTicksPacket::decode,
                TrHamonEnergyTicksPacket::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        
        channel.registerMessage(index++, HamonOutOfBreathPacket.class,
                HamonOutOfBreathPacket::encode,
                HamonOutOfBreathPacket::decode,
                HamonOutOfBreathPacket::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        
        channel.registerMessage(index++, TrVampirismDataPacket.class,
                TrVampirismDataPacket::encode,
                TrVampirismDataPacket::decode,
                TrVampirismDataPacket::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        ...
        channel.registerMessage(index++, TrSyncLivingCapState.class,
                TrSyncLivingCapState::encode,
                TrSyncLivingCapState::decode,
                TrSyncLivingCapState::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
        ...
        channel.registerMessage(index++, TrWalkmanEarbudsPacket.class,
                TrWalkmanEarbudsPacket::encode,
                TrWalkmanEarbudsPacket::decode,
                TrWalkmanEarbudsPacket::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
