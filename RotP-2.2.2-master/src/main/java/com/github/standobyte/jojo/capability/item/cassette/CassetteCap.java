...
public class CassetteCap {
    ...
    public void fromNBT(CompoundNBT nbt) {
        if (nbt.contains("Tracks", JojoModUtil.getNbtId(ListNBT.class))) tracks = TrackList.fromNBT(nbt.getList("Tracks", JojoModUtil.getNbtId(CompoundNBT.class)));
    ...
    private Optional<DyeColor> getColor(CompoundNBT nbt, String nbtKey) {
        if (nbt.contains(nbtKey, JojoModUtil.getNbtId(ByteNBT.class))) {
