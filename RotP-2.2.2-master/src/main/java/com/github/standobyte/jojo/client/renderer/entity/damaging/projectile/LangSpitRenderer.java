...
public class LangSpitRenderer extends EntityRenderer<LangSpitEntity> {
    private static final ResourceLocation LLAMA_SPIT_LOCATION = new ResourceLocation("textures/entity/llama/spit.png");
    private final LlamaSpitModel<LangSpitEntity> model = new LlamaSpitModel<>();

    public LangSpitRenderer(EntityRendererManager p_i47202_1_) {
       super(p_i47202_1_);
    }

    public void render(LangSpitEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
    ...
    public ResourceLocation getTextureLocation(LangSpitEntity p_110775_1_) {
