...
public class IronSwordLayer<T extends LivingEntity, M extends EntityModel<T> & IHasArm> extends LayerRenderer<T, M> {
    
    public IronSwordLayer(IEntityRenderer<T, M> p_i50934_1_) {
        super(p_i50934_1_);
     }

     public void render(MatrixStack p_225628_1_, IRenderTypeBuffer p_225628_2_, int p_225628_3_, T p_225628_4_, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
        ItemStack itemstack1 = new ItemStack(Items.IRON_SWORD);
