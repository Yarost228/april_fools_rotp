...
public class CommonReflection {
    ...
    private static final Field LIVING_ENTITY_JUMPING = ObfuscationReflectionHelper.findField(LivingEntity.class, "field_70703_bu");
    public static boolean isJumping(LivingEntity entity) {
        return ReflectionUtil.getFieldValue(LIVING_ENTITY_JUMPING, entity);
    }
}
