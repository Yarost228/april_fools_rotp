...
public class ClLayoutHotbarPacket {
    ...
    public static void encode(ClLayoutHotbarPacket msg, PacketBuffer buf) {
    ...
    public static ClLayoutHotbarPacket decode(PacketBuffer buf) {
    ...
    public static void handle(ClLayoutHotbarPacket msg, Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
