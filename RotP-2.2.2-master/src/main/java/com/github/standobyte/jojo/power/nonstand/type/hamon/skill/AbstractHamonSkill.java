...
public abstract class AbstractHamonSkill extends ForgeRegistryEntry<AbstractHamonSkill> {
    ...
    private final @Nullable Supplier<HamonAction> rewardAction;
    private final List<Supplier<? extends AbstractHamonSkill>> requiredSkills;

    protected AbstractHamonSkill(String name, RewardType rewardType, @Nullable Supplier<HamonAction> rewardAction, 
