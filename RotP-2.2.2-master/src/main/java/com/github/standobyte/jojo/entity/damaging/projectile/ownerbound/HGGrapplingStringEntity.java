...
public class HGGrapplingStringEntity extends OwnerBoundProjectileEntity {
    ...
    private Action<IStandPower> heldAction;
    ...
    public HGGrapplingStringEntity(EntityType<? extends HGGrapplingStringEntity> entityType, World world, StandEntity entity, IStandPower userStand) {
    ...
    public void setHeldAction(Action<IStandPower> heldAction) {
    ...
    public void tick() {
        ...
        if (!level.isClientSide() && (userStandPower == null || heldAction != null && userStandPower.getHeldAction() != heldAction)) {
        	remove();
        	return;
        }
