...
import com.github.standobyte.jojo.item.DioBoneItem;
...
import com.github.standobyte.jojo.item.ReQuIeMStandArrowItem;
...
//            () -> new ForgeSpawnEggItem(ModEntityTypes.ROCK_PAPER_SCISSORS_KID, 0x563C33, 0xBD8B72, new Item.Properties().tab(JojoMod.MAIN_TAB)));
    ...
    public static final RegistryObject<StandArrowItem> STAND_ARROW_BEETLE = ITEMS.register("stand_arrow_beetle", 
            () -> new ReQuIeMStandArrowItem(new Item.Properties().tab(JojoMod.MAIN_TAB).rarity(Rarity.RARE).durability(250)));
    ...
    public static final RegistryObject<Item> DIO_BONE = ITEMS.register("dio_bone", 
            () -> new DioBoneItem(new Item.Properties().tab(JojoMod.MAIN_TAB)));

//    public static final RegistryObject<Item> BEACH_BOY = ITEMS.register("beach_boy", 
//            () -> new BeachBoyItem(new Item.Properties()));
