...
public abstract class PowerBaseImpl<P extends IPower<P, T>, T extends IPowerType<P, T>> implements IPower<P, T> {
    ...
    @Override
    public boolean clickAction(Action<P> action, boolean shift, ActionTarget target) {
    ...
    @Override
    public ActionTarget getHeldActionTarget() {
        return heldActionData != null ? heldActionData.getActionTarget() : null;
    }
    ...
    public void readNBT(CompoundNBT nbt) {
        ...
        if (nbt.contains("Layout", JojoModUtil.getNbtId(CompoundNBT.class))) {
